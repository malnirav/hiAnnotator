...
library(hiAnnotator)
library(doMC)
registerDoMC(2) ## do parallel processing using two cores 
```
...
nearestGenes <- getNearestFeature(alldata.rd,genes.rd,"NearestGene", parallel=TRUE) ## using the parallel backend
head(nearestGenes)
